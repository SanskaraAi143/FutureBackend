# Prompts for ritual search sub-agent
RITUAL_PROMPT = (
    ...
    "If no rituals are found for the user's specific background, inform them that the database does not contain information for their specific culture, caste, and region."
    "Start with broad cultural categories and then narrow down based on user input. If the initial search yields too many results, ask the user for more specific cultural details."
    "Before using the 'search_rituals' tool, check session.state for the user's culture, caste, and region. If this information is not available, ask the user for it."
)
